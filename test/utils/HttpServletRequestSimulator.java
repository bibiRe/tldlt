...
public class HttpServletRequestSimulator implements HttpServletRequest {
     ...
     * This method returns an empty <code>Enumeration</code> if the request has
     ...
     *         indicating the authentication scheme, or <code>null</code> if the
     *         request was
     *         not authenticated.
     */
     ...
     *         the chararacter encoding, or <code>null</code> if the request
     *         does not specify a character encoding
     */
     ...
     * the type is not known. For HTTP servlets,
     ...
     * represents a Date object. Use this
     * method with headers that contain dates, such as If-Modified-Since. <br>
     * <br>
     * The date is returned as the number of milliseconds since January 1, 1970
     * GMT. The header name is case insensitive. <br>
     * <br>
    ...
    /**
     * Sets a header with the appropriate date string given the time in
     * milliseconds.
     * @param name the name of the header
     * @param millis the time in milliseconds
     */
    public void setDateHeader(String name, long millis) {
        String dateString = new SimpleDateFormat("EEE, d MMM yyyy HH:mm:ss z")
     ...
     *         header, or <code>null</code> if the request does not
     ...
     * headers using this method, in which case this method returns
     * <code>null</code>
     ...
     *         allow servlets to use this method, <code>null</code>
     */
    @SuppressWarnings("rawtypes")
    ...
    public Enumeration getHeaders(String s) {
        throw new UnsupportedOperationException(
                "getHeaders operation is not supported!");
    }
    ...
    public ServletInputStream getInputStream() throws IOException {
        throw new UnsupportedOperationException(
                "getInputStream operation is not supported!");
    }
    ...
    public int getIntHeader(String s) {
        ...
        if (header != null) {
            try {
                ...
                throw new NumberFormatException("header '" + s
                        + "' cannot be converted to number format.");
            }
        } else
            return -1;
    }
     ...
     * @return an <code>Enumeration</code> of preferred Locale objects for the
     *         client
     */
     ...
     * all of the values the given request parameter has, or <code>null</code>
    ...
    public String getPathTranslated() {
        throw new UnsupportedOperationException(
                "getPathTranslated operation is not supported!");
    }
     ...
     * URL after the path. This method returns <code>null</code> if the URL does
     * not have a query string. Same as the value
    ...
    public BufferedReader getReader() throws IOException {
        throw new UnsupportedOperationException(
                "getReader operation is not supported!");
    }
    ...
    public String getRealPath(String path) {
        File contextDirectory = ((ServletContextSimulator) context)
                .getContextDirectory();
     ...
     * the URL easily, for example, to append query parameters. <br>
     * <br>
     ...
     *            <code>false</code> to return <code>null</code> if there's no
     *            current session
     * @return the <code>HttpSession</code> associated
     *         with this request or <code>null</code> if <code>create</code> is
    ...
    public HttpSession getSession(boolean b) {
        if ((session == null) && (b))
            this.session = new HttpSessionSimulator(context);
                ...
                && (!((HttpSessionSimulator) session).isValid()) && (b))
            this.session = new HttpSessionSimulator(context);
     ...
     *         the name of the user making this request; <code>null</code> if
     ...
     *             API, use {@link #isRequestedSessionIdFromURL} instead.
     */
     ...
     *            defined in this class: {@link #GET}, {@link #POST}, and
     *            {@link #PUT}
     */
    ...
    public void setRequestURL(String url) {
        ...
        // set uri
        setRequestURI(url.substring(url.indexOf('/', schemeIndex + 3),
                queryIndex));
        ...
        if (portIndex > 0) {
            ...
            setServerPort(Integer.parseInt(url.substring(portIndex + 1,
                    url.indexOf('/', schemeIndex + 3))));
        } else {
            setServerName(url.substring(schemeIndex + 3,
                    url.indexOf('/', schemeIndex + 3)));
            if (isSecure())
                setServerPort(443);
            else
