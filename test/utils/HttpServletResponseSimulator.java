...
public class HttpServletResponseSimulator implements HttpServletResponse {
    private OutputStream servOStream; // The non-default
    ...
    public void addDateHeader(String name, long date) {
        this.headers.put(name, new SimpleDateFormat(
                "EEE, d MMM yyyy HH:mm:ss z").format(new Date(date)));
    }
    ...
    public void flushBuffer() throws IOException {
        throw new UnsupportedOperationException(
                "flushBuffer operation is not supported!");
    }
    ...
    public ServletOutputStream getOutputStream() throws IOException {
        if (this.calledGetWriter)
            throw new IllegalStateException(
                    "The getWriter method has already been called");
        ...
        // resets the status of servOStream to prevent us from possible using a
        // closed stream
     ...
     * in the <code>charset=</code> property of the {@link #setContentType}
    ...
    public PrintWriter getWriter() throws IOException {
        if (this.calledGetOutputStream)
            throw new IllegalStateException(
                    "The getOutputStream method has already been called");
    ...
    /**
     * Returns the status code for this response, which is useful for testing
     * expected errors.
